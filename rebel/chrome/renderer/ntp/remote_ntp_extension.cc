...
static const char kDispatchNtpTilesChangedScript[] =
    "if (window.rebel &&"
...
static const char kDispatchBackgroundCollectionsChangedScript[] =
    "if (window.rebel &&"
    "    window.rebel.theme &&"
...
static const char kDispatchBackgroundImagesChangedScript[] =
    "if (window.rebel &&"
    "    window.rebel.theme &&"
...
static const char kDispatchLocalBackgroundImageSelectedScript[] =
    "if (window.rebel &&"
    "    window.rebel.theme &&"
...
static const char kDispatchThemeChangedScript[] =
    "if (window.rebel &&"
    "    window.rebel.theme &&"
...
// Populates a Javascript NTP tile object for returning from remoteNtp.ntpTiles.
...
// remoteNtp.search.autocompleteResult.matches.(contentsClass|descriptionClass).
...
// remoteNtp.search.autocompleteResult.
...
// remoteNtp.theme.backgroundCollections.
...
// remoteNtp.theme.backgroundImages.
...
// Populates a Javascript theme object for returning from remoteNtp.theme.theme.
...
class ThemeBindings : public gin::Wrappable<ThemeBindings> {
 ...
 private:
  ...
  static v8::Local<v8::Value> GetThemeColors(v8::Isolate* isolate) {
    ...
    for (int i = 0; i < static_cast<int>(chrome_colors::kNumColorsInfo); ++i) {
      ...
      v8::Local<v8::Object> v8_color_info =
          gin::DataObjectBuilder(isolate)
              ...
              // TODO(tflynn): |icon_data| no longer exists.
