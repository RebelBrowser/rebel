...
const InstallConstants kInstallModes[] = {
    // The primary (and only) install mode for stable Rebel-branded browsers.
    {
        ...
        .index =
            REBEL_INDEX,  // The one and only mode for Rebel-branded browsers.
        .install_switch =
        ...
        .base_app_name = L"" REBEL_STRING_BUILDFLAG(
            REBEL_BROWSER_NAME),  // A distinct base_app_name.
        .base_app_id = L"" REBEL_STRING_BUILDFLAG(
            REBEL_BROWSER_NAME_WITH_UNDERSCORES),  // A distinct base_app_id.
        .prog_id_prefix = L"" REBEL_STRING_BUILDFLAG(
            REBEL_BROWSER_COMPANY_PATH) "HTML",  // ProgID prefix.
        .prog_id_description = L"" REBEL_STRING_BUILDFLAG(
            REBEL_BROWSER_NAME) " HTML Document",  // ProgID description.
        .active_setup_guid =
