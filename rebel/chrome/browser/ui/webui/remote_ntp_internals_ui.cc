...
#else
    AllowJavascript();
    CallJavascriptFunction("cachedIconsAvailable", std::move(icons));
#endif
  }
...
#else
    AllowJavascript();
    CallJavascriptFunction("iconImageAvailable", std::move(icon));
#endif
  }

  rebel::RemoteNtpIconStorage* remote_ntp_icon_storage_;
...
RemoteNtpInternalsUI::RemoteNtpInternalsUI(content::WebUI* web_ui)
  ...
  content::WebUIDataSource* html_source =
      content::WebUIDataSource::Create(rebel::kRemoteNtpInternalsHost);
