...
bool RebelContentBrowserClient::ShouldUseSpareRenderProcessHost(
  ...
  if (RemoteNtpServiceImpl::ShouldAssignUrlToRemoteNtpRenderer(site_url,
                                                               profile)) {
    return false;
  }
...
void RebelContentBrowserClient::SiteInstanceGotProcess(
  ...
  if (RemoteNtpServiceImpl::ShouldAssignUrlToRemoteNtpRenderer(
  ...
  ChromeContentBrowserClient::SiteInstanceGotProcess(site_instance);
}
