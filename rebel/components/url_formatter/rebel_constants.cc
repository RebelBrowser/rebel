...
bool SwapSchemas(GURL& url,
                 std::string_view source_schema,
                 std::string_view replacement_schema) {
...
bool ReplaceChromeSchemeWithRebelScheme(std::u16string& url) {
  static constexpr const std::u16string_view chrome_scheme_with_separator =
      u"chrome://";
  static constexpr const std::u16string_view rebel_scheme_with_separator =
